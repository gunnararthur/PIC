...
urlpatterns = [
    ...
    url(r'^(?P<contact_id>[0-9]+)/(?P<group_id>[0-9]+)/$', views.confirm_enrollment, name='confirm_enrollment'),

    url(r'^(?P<contact_id>[0-9]+)/(?P<group_id>[0-9]+)/stadfest$', views.send_confirmation, name='send_confirmation'),
